...
public class FlammeViolettePiece : Piece
{
    ...
    protected override void OnTurnStart()
    {
        ...
        if (baron != null)
        {
            ...
            Debug.Log($"[FlammeViolette] +1 PO via Baron Samedi (total = {baron.GetShadowPoints()})");
        }
        else
        {
            Debug.LogWarning("[FlammeViolette] Aucun BaronSamediMaskPiece trouvé pour créditer le PO !");
        }
    }
